...
public class PushHandlerActivity extends Activity {
    ...
    private static final String LCAT = "PushHandlerActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        try {
            ...
            String notification = getIntent().getStringExtra("ti.pushwoosh.data");
            ...
            launcherIntent.putExtra("ti.pushwoosh.data", notification);
